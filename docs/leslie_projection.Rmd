...
# creating a sequence of the years, which goes from 1-8
time_yr <- seq(from = 0, to = 8, by = 1)

# we are creating an empty matrix that is 4x8
# 
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# using the function we created, we calculate the initial pop at year 0
proj_year[1, ] <- fish_year0

# The for loop below calculates the projected year for all 8 years
